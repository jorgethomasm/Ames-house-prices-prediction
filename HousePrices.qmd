...
**Note how problematic are the outliers with the spline fit!** This visual allows me to *remove outliers*, i.e., the biggest and cheap houses (right data points).
...
#| cap-location: margin
#| fig-cap: "Houses with mid-quality levels are most frequent in the train dataset. I think I can reduce the categories to seven (8), grouping or lumping 1 and 2."
#| column: margin
#| code-fold: false
...
Now I'll group (lump) into one category `OverallQual = 1` and `OverallQual = 2`.
