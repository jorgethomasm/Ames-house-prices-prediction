...
ames_all <- ames_all |>
  mutate(SalePrice = (SalePrice^boxcox_lambda - 1) / boxcox_lambda)
...
[Note that `SalePrice` is already transformed. See [here](https://www.tmwr.org/recipes.html#skip-equals-true)]{.column-margin}
