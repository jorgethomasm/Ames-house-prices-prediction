...
mixture_ <- c(0.5, 0.55, 0.6, 0.65, 0.7)  # TODO: ADD 0.45
...
New fit with new feature engineering, mean RMSE = 0.0637 (1000 Bootstraps). **Kaggle's Top 15%**. Best so far...
...
write.csv(sub_elasticnet, "./data/submissions/jthom_sub_4_elasticnet.csv", quote = FALSE, row.names = FALSE)
...
# library(usemodels)
# usemodels::use_xgboost(SalePrice_bc ~ ., data = ames_train)
...
#   min_n = 6
#   tree_depth = 3
#   learn_rate = 0.016264141166364
#   loss_reduction = 2.85800562773311e-08
#   sample_size = 0.673825541965198
...
The simplest ensemble often very effective when the nature of the models are different, like in this case!
The Elastic-Net regression had a better RMSE than the XGBoost, therefore I can weight it more.

```{r}
#| label: stack_1
#| eval: false

sub_stack_1 <- (elastic_net_pred + elastic_net_pred + xgboost_pred)/3
