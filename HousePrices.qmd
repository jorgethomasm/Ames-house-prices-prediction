...
mixture_ = c(0.5, 0.55, 0.6, 0.65, 0.7)
...
# read_rds(file = "./models/final_models/final_glmnet.Rdata")
# final_glmnet
...
write.csv(sub_elasticnet, "./data/submissions/jthom_sub_3_elasticnet.csv", quote = FALSE, row.names = FALSE)

```

New fit with new feature engineering, mean RMSE = 0.0640 (1000 Bootstraps). **Kaggle's Top 15%**. Best so far...
