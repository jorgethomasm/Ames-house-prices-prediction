...
#| fig-width: 7
#| fig-height: 5
#| fig-cap: 'OverallQual Vs. SalePrice - The most "linear" realationship with a categorical predictor.'
...
ames_all |>
  filter(dataset == "train") |>
  ggplot(aes(x = SalePrice/1000, y = OverallQual, colour = OverallQual, fill = OverallQual)) +     
  geom_rain(alpha = 0.5) +  
  scale_x_continuous(breaks = seq(0, 800, 50)) +  
  labs(x = "Sale Price ['000 $]", y = "Overall Quality")

# ames_all |>
#   filter(dataset == "train") |> 
#   ggplot(aes(x = YrSold, y = SalePrice/1000)) +
#   geom_rain(rain.side = 'r', alpha = 0.5) +
#   #scale_y_continuous(breaks = seq(0, 800, 100), labels = scales::comma) +   
#   labs(y = "Sale Price [$]", x = "Year\nSold") +
...
#| fig-width: 6
#| fig-height: 6
#| fig-cap: "Analysis of the target variable."
#| fig-subcap: 
#|   - "Histogram"
#|   - "Q-Q Plot"
#| layout-ncol: 2
...
... and it is, indeed. Well, except for the tails, now it's more normal-like at the core.
