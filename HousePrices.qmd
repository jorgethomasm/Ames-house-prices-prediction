...
[^4]: Tip: Forget about interpretability if you want the most accurate results.  
...
Logarithmic transformations work when there are few large values, like in this case, there are only a few expensive hauses. The logarithm scale will shrink that right tail[^4], making the distribution of the values more normal-like.

[^4]: Tip: think of a **Logarithmic transformation** like pressing an **accordeon** only from your right arm.
