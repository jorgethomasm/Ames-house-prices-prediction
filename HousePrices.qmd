...
simplest_rec <-
  ...
  step_BoxCox(all_numeric(), limits = c(-1, 1)) |> 
  step_scale(all_numeric_predictors())

# Multi-lm 
multi_lm_rec <-
  recipe(SalePrice ~ GrLivArea + TotBaths + GarageCars + TotalBsmtSF + YearBuilt + MasVnrArea + OverallQual + KitchenQual + ExistFireplace, data = ames_train) |>
  step_BoxCox(all_numeric(), limits = c(-1, 1)) |> 
  step_scale(all_numeric_predictors()) |>
