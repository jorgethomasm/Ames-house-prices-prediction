...
jalsggtheme <- theme_minimal() +
  theme(
        plot.title = element_text(size = 10, hjust = 0.5),
        axis.ticks = element_line(),
        # Y-axis:
        axis.title.y = element_text(angle = 0, size = 9, vjust = 0.5, face = "bold"),
        axis.text.y  = element_text(size = 8),
        # X-axis:
        axis.title.x = element_text(angle = 0, size = 9, vjust = 0.5, face = "bold"),
