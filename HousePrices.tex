...
\hypersetup{
  pdftitle={Prediction of House Prices in Ames, Iowa},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Prediction of House Prices in Ames, Iowa}
\usepackage{etoolbox}
\makeatletter
...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, interior hidden, enhanced, frame hidden, boxrule=0pt, sharp corners, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
...
(\textbf{xie2018?})\marginpar{\begin{footnotesize}xie2018\vspace{2mm}\par\end{footnotesize}}.
...
tight integration of graphics with text, and well-set typography.
Quarto\sidenote{\footnotesize To learn more, you can read more about
...
\AttributeTok{      }\FunctionTok{margin{-}width}\KeywordTok{:}\AttributeTok{ 350px}\hspace*{\fill}\NormalTok{\circled{1}}
\AttributeTok{  }\FunctionTok{pdf}\KeywordTok{:}\AttributeTok{ default}
\FunctionTok{reference{-}location}\KeywordTok{:}\AttributeTok{ margin}\hspace*{\fill}\NormalTok{\circled{2}}
...
\item
  ...
  chunk, and we will take care of the details for you\sidenote{\footnotesize You never
...
\CommentTok{\#| label: fig{-}margin}
\CommentTok{\#| fig{-}cap: "MPG vs horsepower, colored by transmission."}
...
{\centering \includegraphics{HousePrices_files/figure-pdf/fig-margin-1.pdf}
...
margin. Captions can even contain elements like a citation such as
(\textbf{xie2018?}).\linebreak\linebreak\protectxie2018\linebreak}
...
2023)\marginpar{\begin{footnotesize}\leavevmode\vadjust pre{\protect\hypertarget{ref-R-base}{}}%
...
{\centering \includegraphics{HousePrices_files/figure-pdf/fig-two-separate-1.pdf}
...
{\centering \includegraphics{HousePrices_files/figure-pdf/fig-two-separate-2.pdf}
